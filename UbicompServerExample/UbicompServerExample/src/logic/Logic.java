...
public class Logic 
{
	 ...
	 */
	public static ArrayList<Placa> getPlacasFromDB()
	{
		...
		try
		{
			...
			while (rs.next())
			{
				Placa placa = new Placa(0, null, 0, null);
				placa.setIdPlaca(rs.getInt("ID"));
				placa.setUbicacion(rs.getString("UBICACION"));
				placa.setOrientacion(rs.getInt("ORIENTACION"));
				placa.setEmail(rs.getString("EMAIL"));
				placas.add(placa);
			}	
